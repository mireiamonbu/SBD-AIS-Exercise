...
func prepopulate(dbConn *gorm.DB) error {
	...
	drinks := []model.Drink{
		{Name: "Water", Description: "Normal water", Price: 0.59},
		{Name: "Orange Juice", Description: "Natural orange juice", Price: 1.00},
		{Name: "Martini", Description: "Vermut", Price: 4.30},
		{Name: "White Wine", Description: "Wine of selection", Price: 2.50},
		{Name: "Red Wine", Description: "Wine of selection", Price: 3.00},
		{Name: "Beer", Description: "Normal beer", Price: 3.00},
	}
